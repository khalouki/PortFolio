...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/50 bg-secondary/30 backdrop-blur-lg">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Data Science & Software Engineer passionate about building intelligent solutions.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Link href="#education" className="block text-sm text-muted-foreground hover:text-primary transition-colors">
                Education
              </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="p-2 rounded-lg bg-secondary/50 hover:bg-primary/20 transition-all duration-300 border border-border/50 hover:border-primary/50"
              >
        ...
        <div className="border-t border-border/50 pt-8 flex flex-col sm:flex-row items-center justify-between text-sm text-muted-foreground">
          <p>&copy; {currentYear} Abdelkhalk Essaid. All rights reserved.</p>
